...
public class SignupManager extends JFrame{
    ...
    public boolean setLoginManagerReference(LoginManager lmg){
        this.lmg = lmg;
        return true;
    }

    public boolean setUserIdentifier(String userIdentifier){//Trick used to consider weather Signup will be for user or seller.
    ...
    public boolean hideLoginButton(){
        button_login.setVisible(false);
        return true;
    }
    
//    public boolean sign_up(String a,String b,String c,String d ){
//     return true;
//    }
