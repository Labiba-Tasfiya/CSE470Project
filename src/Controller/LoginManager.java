...
//    JDataBase jdb;
//    public LoginManager(JDataBase jdatabase){
//        jdb=jdatabase;
//    
//    }
    ...
    public boolean clearTextFields(){ //This method called from every place where Log Out button is present so that last username nad password not shown.
...
//    public boolean signin(String a, String b){
